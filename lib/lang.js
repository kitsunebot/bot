...
class LanguageProcessor {
    ...
    computeResponse(msg, key, replacer, skipPrefix) {
        ...
        return (isPrivate || skipPrefix ? '' : utils.replace(this.langfiles[config.languages.default]['username'], {username: (isPrivate ? msg.author.user.username : msg.member.nick)})) + ' ' + this.computeLangString(isPrivate ? msg.author.id : msg.channel.guild.id, key, isPrivate, replacer);
    }
