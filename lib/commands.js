...
var pubsub = require('./redis_pubsub');
...
commands.addwaifu = {
    ...
    alias: [],
    min_perm: 0,
    args: 'waifu name | waifu source | picture link',
    allow_disable: true,
    handlers: {
        default: function (msg) {
            //todo
...
commands.listwaifu = commands.listwaifus = {
    _id: 22,
    main_cmd: 'listwaifu',
    alias: ['listwaifus'],
    min_perm: 0,
...
commands.disablecommand = commands.disablecommands = {
    _id: 25,
...
commands.enablecommand = commands.enablecommands = {
    _id: 25,
